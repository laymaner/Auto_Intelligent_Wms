...
{
    public class MaterialStock_HistoryConfig : IEntityTypeConfiguration<MaterialStock_History>
    {
        public void Configure(EntityTypeBuilder<MaterialStock_History> builder)
        {
            builder.ToTable("Mask_STK_MaterialStock_Histories");
            builder.HasComment("库存历史记录");
            builder.Property(m => m.OrderCode).HasMaxLength(20).HasComment("订单号").IsRequired();
            builder.Property(m => m.OrderType).HasMaxLength(5).HasComment("订单类型").IsRequired();
            ...
            builder.Property(m => m.OperateQuantity).HasComment(" 操作数量").IsRequired();
            ...
            builder.Property(m => m.OperateType).HasMaxLength(2).HasComment("操作类型").IsRequired();
