...
namespace Auto_Intelligent_Wms.Core.Model.BaseModel
{
    ...
    public class ApiResult<T>
    {
        ...
        public string? Message
        {
            get
            {
                return !string.IsNullOrEmpty(_msg) ? _msg : EnumUtil.GetEnumDescription(Status);
            }
            set
            {
                _msg = value;
        ...
        {
            return new ApiResult<T> { Status = ResultStatusEnum.Success, Success = true, Data = data };
        }
        ...
        {
            return new ApiResult<T> { Status = ResultStatusEnum.Fail, Success = false, Message = msg };
        }
        ...
        {
            return new ApiResult<T> { Status = ResultStatusEnum.NotFound, Success = false, Message = msg };
        }
        ...
        {
            return new ApiResult<T> { Status = ResultStatusEnum.Error, Success = false, Message = msg };
        }
        ...
        {
            return new ApiResult<T> { Status = status, Success = isSuccess, Data = data, Message = msg };
        }
